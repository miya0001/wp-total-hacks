...
<div class="block">
    ...
    <div class="block_content">
        <p>Add Google analytics code. Logged in user will be excluded.</p>
        <textarea name="wfb_google_analytics" id="wfb_google_analytics" cols="50" rows="7"><?php $this->op('wfb_google_analytics'); ?></textarea>
    </div>
</div>
